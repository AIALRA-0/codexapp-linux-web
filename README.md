...
这个结果证明超大任务可以完整打开，但不代表它已经足够快。当前没有加入可能显示旧内容的私有缓存；后续性能工作必须继续区分“官方解析时间、宿主处理时间和真实公网时间”
...
- ChatGPT / Codex renderer：`26.803.81509`
- 官方构建号：`6415`
- Codex app-server：`0.147.0-alpha.6.6`
- preload 契约：21 个方法
